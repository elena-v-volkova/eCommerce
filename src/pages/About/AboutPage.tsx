  ...
  return (
    <>
      ...
      <section className="flex justify-center py-12">
        ...
        >
          <svg
            className="h-auto w-32 fill-current text-black dark:text-white"
            fill="none"
            height="206"
            viewBox="0 0 553 206"
            width="553"
          ...
          >
            ...
            <defs>
              <clipPath id="clip0_21892_185">
                <rect fill="white" height="205.3" width="552.8" />
              </clipPath>
            </defs>
          </svg>
        </Link>
